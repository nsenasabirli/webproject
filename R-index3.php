...
<div class="px-4 py-5 my-5 text-center">
  <img class="d-block mx-auto mb-4" src="WOW.png" alt="" width="72" height="60">
  <h1 class="display-5 fw-bold text-body-emphasis">World Of Wonders</h1>
  <div class="col-lg-6 mx-auto">
    <p class="lead mb-4">Welcome to WOW! We have got your taste in every category we provide.</p>
