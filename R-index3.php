  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <a href="R-BookDetails.php?username=<?php echo $username; echo "&bookId=13079982-fahrenheit-451";?>">
		...
		<img src="https://m.media-amazon.com/images/I/61z7RDG3OIL._AC_UF894,1000_QL80_.jpg" alt="Image" width="100" height="150" class="me-2" style="margin-bottom: 10px;"></a>

    <a href="R-BookDetails.php?username=<?php echo $username; echo "&bookId=3.Harry_Potter_and_the_Sorcerer_s_Stone";?>">
		
		<img src="https://m.media-amazon.com/images/I/71RVt35ZAbL._AC_UF1000,1000_QL80_.jpg" alt="Image" width="100" height="150" class="me-2" style="margin-bottom: 10px;"></a>
